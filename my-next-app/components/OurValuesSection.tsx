...
import { Recycle, Waves, Fish, ShieldOff } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-gray-600 text-lg mb-4 leading-relaxed">
              <strong>Eco-Friendly Products:</strong> Made from biodegradable
              materials that are safe for the planet, leaving no trace behind.
            </p>

            <p className="text-gray-600 text-lg mb-4 leading-relaxed">
              <strong>Safe for All Ages:</strong> Non-toxic and perfect for
              worry-free family fun, whether at the beach or in your backyard.
            </p>

            <p className="text-gray-600 text-lg mb-8 leading-relaxed">
              <strong>Durable for Casual Use:</strong> Built for reliable
              performance and lasting enjoyment for players of all levels.
            </p>
