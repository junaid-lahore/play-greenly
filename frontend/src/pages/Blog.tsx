        ...
        <header className="container mx-auto px-4 py-6 flex justify-between items-center">
          ...
          <nav aria-label="Main Navigation">
            <ul className="flex space-x-8">
              ...
              <li><Link to="/contact-us" className="text-brand-black hover:text-brand-teal transition-colors font-body font-medium">Contact</Link></li>
              <li><Link to="/blog" className="text-brand-teal font-bold transition-colors font-body medium" aria-current="page">Blog</Link></li>
            </ul>
          </nav>
        </header>
