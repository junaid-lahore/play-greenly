    ...
    <div className="min-h-screen bg-gradient-to-b from-brand-gray to-brand-white text-brand-black">
      ...
      <div className="min-h-screen bg-gradient-to-b from-brand-gray to-brand-white text-brand-black">
        <header className="container mx-auto px-4 py-6 flex justify-between items-center">
          <div className="text-2xl font-title font-bold text-brand-black" aria-label="Play Greenly Logo">
            <Link to="/">Play Greenly</Link>
          </div>
          <nav aria-label="Main Navigation">
            <ul className="flex space-x-8">
              <li><Link to="/" className="text-brand-black hover:text-brand-teal transition-colors font-body font-medium">Home</Link></li>
              <li><Link to="/about-us" className="text-brand-black hover:text-brand-teal transition-colors font-body font-medium">About</Link></li>
              <li><span className="text-brand-teal font-bold font-body font-medium cursor-default" aria-current="page">Contact</span></li>
              <li><Link to="/blog" className="text-brand-black hover:text-brand-teal transition-colors font-body font-medium">Blog</Link></li>
            </ul>
          </nav>
        </header>

        <main className="container mx-auto px-4 py-16 sm:py-20 lg:py-24 text-brand-black">
